        ...
        NavigationStack {
            ...
            ScrollView {
                    ...
                    VStack{
                        ...
                        Text("Though vaping is not certianly a factor that causes cancer, there are still negative effects. For example throat and mouth irritation, headache, cough and feeling sick. Most e-cigarttes have nicotine in them which is addictive. Many teens become After using a vape for a long time there can be serious health issues. ")
